...
(Respect `$MICRO_CONFIG_HOME` if you've set it: use `$MICRO_CONFIG_HOME/syntax/`.)
...
`//` and `/* */` comments, operators, and function names). For GitHub, see the
`linguist-language=C++` mapping in `.gitattributes` instead — GitHub only
